...
var APP =
	React.createClass({displayName: "APP",
		render:function(){
			return React.createElement("h1", null, "MY APP MuDAFuCKA")
		}
	});
module.exports = APP;
...
var Card = React.createClass({displayName: "Card", //1 people card
    render: function() {
        return(
            React.createElement("div", null, 
                ...
                React.createElement("div", null), 
                React.createElement("button", {onClick: this.props.onClick}, "AHORITA NO JOVEN")
            )
        )
    }
});
...
//-----------------
var Tit = React.createClass({displayName: "Tit", //1 people card
    render: function() {
        return(
            React.createElement("div", null, 
                React.createElement("h1", null, "SO WHAT WE GET DRUNK, ", this.props.name), 
                React.createElement("h2", null, "we just having fun!")
            )
        )
    }
});
 
React.render(React.createElement(App, {people: doorpeople}), document.getElementById('container'));
React.render(React.createElement(Tit, {name: "SO WHAT WE SMOKE WEED"}), document.getElementById('title'));
React.render(
